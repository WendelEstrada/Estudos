...
{
    public class AlunoParaAtualizacaoValidator : AbstractValidator<Aluno>
    {
        private readonly IRepository<Aluno> _repository;

        public AlunoParaAtualizacaoValidator(IRepository<Aluno> repository)
        {
        ...
        private bool RegistroUnico(Aluno aluno)
        {
            ...
            if (alunoEncontrado.Registro == aluno.Registro)
                return true;
